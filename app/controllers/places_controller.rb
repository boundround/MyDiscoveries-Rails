class PlacesController < ApplicationController
  ...
  private
    def place_params
      params.require(:place).permit(:code, :identifier, :display_name, :description, :subscription_level, :latitude, :longitude, :icon, :map_icon, :passport_icon, :address, :area_id, photos_attributes: [:place_id, :title, :path, :caption, :credit])
    end

    def place_update_params
      params.require(:place).permit(:display_name, :description, :address, :subscription_level, photo: [:title, :path, :credit, :caption, :place_id])
    end
end
