module ApplicationHelper
  ...
  def draw_hero_background(place)
    if !place.hero_image_url.blank?
      ...
      if place.primary_category.blank?
        ...
        "https://d1w99recw67lvf.cloudfront.net/category_icons/large_generic_" + place.primary_category.identifier + ".jpg"
      end
    else
  ...
  def draw_small_background(place)
    if place.photos.blank? && place.user_photos.blank?
      if place.primary_category.blank?
        ...
        "https://d1w99recw67lvf.cloudfront.net/category_icons/small_generic_" + place.primary_category.identifier + ".jpg"
      end
    else
      if place.photos.find_by(hero: true)
