...
Crafty.extend({
    ...
    mouseDispatch: function (e) {
        ...
        e.realX = x = Crafty.mousePos.x = pos.x/globalScale;
        e.realY = y = Crafty.mousePos.y = pos.y/globalScale;
    ...
    touchDispatch: function (e) {
        ...
        if (e.type === "touchstart") type = "click";
        ...
        //Don't prevent default actions if target node is input or textarea.
				//Bound Round don't prevent default if touching the scene so drag is supported on ios
        if (e.target && e.target.nodeName !== 'INPUT' && e.target.nodeName !== 'TEXTAREA' && e.target.id !== 'cr-stage') {
    ...
    keyboardDispatch: function (e) {
        ...
        if (Crafty.selected && !(e.key == 8 || e.key >= 112 && e.key <= 135)) {
            ...
            if (e.target && e.target.nodeName !== 'INPUT' && e.target.nodeName !== 'TEXTAREA') {
                ...
                //Modification by Cyril Gaillard
                e.preventDefault();
            }
            return false;
        }
...
(function testSupport() {
     ...
     * @see Crafty.viewport
     */
    //modification by Cyril Gaillard. Mobile detection off because of new Global Scale 
...
Crafty.extend({
    ...
    load: function (data, oncomplete, onprogress, onerror) {
        ...
        var j = 0,
            ...
            //Modification by Cyril Gaillard to accept images with extension
