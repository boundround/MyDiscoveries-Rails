...
places = []
#fillarraydictcheck(book.sheet_by_name("Places"), places,"Area",area_id)
fillarraydict(book.sheet_by_name("Places"), places)

dcs = []
for area in places:
  dc = {}
  dc['address'] = area['address_directory']
  dc['description'] = area['description_directory']
  dc['discount_summary'] = area['discount_summary']
  dc['image'] = area['Logo_image']
  dc['identifier'] = area['identifier']
  dc['opening_hours'] = area['opening_hours_directory']
  dc['phone_number'] = area['phone_number_directory']
  dc['terms_and_conditions'] = ''
  dc['venue_name'] = area['venue_name']
  dc['website'] = area['website_directory']


  dcs.append(dc)

parse_obj = {}
parse_obj['results'] = dcs
print json.dumps(parse_obj)
