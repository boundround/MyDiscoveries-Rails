...
def handleMappedItem(itemtype,item):
...
#            print(item)
            if retrievereport (aws_icons_bucket+urllib2.quote(item+"_m.png"), local_icons_bucket+item+"_m.png", itemtype):
                ...
                retrievereport (aws_icons_bucket+urllib2.quote(item+"_p.png"), local_icons_bucket+item+"_p.png", itemtype)
...
local_bucket = '/Users/chrisrobertson/Desktop/Workbench/test/'+area+'/template/'
...
dropbox_videos_bucket = "/Users/chrisrobertson/Desktop/Workbench/test/videos/"
...
for place in areajson['places'] :
    ...
    if pgame != "" and pgame != None : place['Game'] = json.loads(pgame)
