...
RSpec.describe CompetitionsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested competition as @competition" do
      competition = Competition.create! valid_attributes
      get :show, params: {id: competition.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested competition as @competition" do
      competition = Competition.create! valid_attributes
      get :edit, params: {id: competition.to_param}, session: valid_session
      expect(assigns(:competition)).to eq(competition)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Competition" do
        expect {
          post :create, params: {competition: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved competition as @competition" do
        post :create, params: {competition: invalid_attributes}, session: valid_session
        expect(assigns(:competition)).to be_a_new(Competition)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested competition" do
        competition = Competition.create! valid_attributes
        put :update, params: {id: competition.to_param, competition: new_attributes}, session: valid_session
        competition.reload
      ...
      it "assigns the requested competition as @competition" do
        competition = Competition.create! valid_attributes
        put :update, params: {id: competition.to_param, competition: valid_attributes}, session: valid_session
        expect(assigns(:competition)).to eq(competition)
      end
    ...
    context "with invalid params" do
      it "assigns the competition as @competition" do
        competition = Competition.create! valid_attributes
        put :update, params: {id: competition.to_param, competition: invalid_attributes}, session: valid_session
        expect(assigns(:competition)).to eq(competition)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested competition" do
      competition = Competition.create! valid_attributes
      expect {
        delete :destroy, params: {id: competition.to_param}, session: valid_session
      }.to change(Competition, :count).by(-1)
    end
